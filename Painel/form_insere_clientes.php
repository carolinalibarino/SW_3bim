        ...
        <div class="container-fluid px-4">
            ...
            <form action="insere_clientes.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" name="email" placeholder="ex.: email@gmail.com" required>
                </div>
                <div class="mb-3">
                    <label for="telefone" class="form-label">Telefone</label>
                    <input type="text" class="form-control" name="telefone" placeholder="ex.: (99) 90000-0000" required>
                </div>
